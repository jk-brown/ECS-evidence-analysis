...
weight the models using inbuilt criterion (observed CO2 concentration and observed global mean surface temperature). It is possible to also add other criterion, for example we may create a criterion with data for ocean carbon uptake. 
